...
export default function HRDonna() {
  ...
  return (
    <div className="h-full w-full flex items-start justify-start">
      <div className="w-full max-w mx-auto h-screen flex flex-col bg-gradient-to-br from-[#cfdef3] to-[#e0eafc]">
        {/* Chat Header */}
  ...
  {/* Chat Messages */}
  <div className="w-[800px] h-[calc(100vh-160px)] overflow-y-auto bg-transparent p-1 space-y-4 mx-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
